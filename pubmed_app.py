...
# ------------------------ USER FEEDBACK ------------------------
    ...
    edited_feedback = st.experimental_data_editor(
        df_feedback, num_rows="dynamic", use_container_width=True
    )
    ...
    (edited_feedback if 'edited_feedback' in locals() else df_feedback).to_excel(download_buffer, index=False)
